...
<body class="bg-gray-900 text-gray-200 font-sans p-6">
    ...
    <div class="container mx-auto">
        ...
        <div class="bg-gray-800 p-8 rounded-lg shadow-lg max-w-lg mx-auto">
            <h3 class="text-3xl font-semibold text-center mb-6">Tambah Data Dokter</h3>
            <form method="post" action="inputuserDokter.php" class="space-y-4">
                <div>
                    <label for="code_dokter" class="block text-sm font-medium text-gray-300 mb-2">Code Dokter</label>
                    <input type="text" name="code_dokter" id="code_dokter" required class="w-full p-3 rounded bg-gray-700 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
                <div>
                    <label for="namaDokter" class="block text-sm font-medium text-gray-300 mb-2">Nama</label>
                    <input type="text" name="namaDokter" id="namaDokter" required class="w-full p-3 rounded bg-gray-700 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
                <div>
