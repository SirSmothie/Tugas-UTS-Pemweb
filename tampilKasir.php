...
<body class="bg-gray-900 text-gray-200 font-sans p-6">
    ...
    <div class="container mx-auto">
        ...
        <!-- Main Content -->
        <h2 class="text-3xl font-semibold text-center mt-8">Data Kasir</h2>

        <!-- Add Button -->
        <div class="text-center my-4">
            <form method="POST" action="tambahKasir.php" class="inline">
            ...
            <table class="min-w-full bg-gray-800 text-gray-200 border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Code Kasir</th>
                        ...
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Gender</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="hover:bg-gray-700 hover:text-white">
                            ...
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($d['namaKasir']); ?></td>
                            ...
                            <td class="border px-4 py-2">
                                <a href="ubahKasir.php?code_kasir=<?php echo $d['code_kasir']; ?>" class="bg-yellow-600 hover:bg-yellow-700 text-white py-1 px-3 rounded shadow">Ubah</a>
                                <a href="hapusKasir.php?code_kasir=<?php echo $d['code_kasir']; ?>" class="bg-red-600 hover:bg-red-700 text-white py-1 px-3 rounded shadow">Hapus</a>
                            </td>
                        </tr>
                    <?php 
                    }
