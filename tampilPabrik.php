...
<head>
    ...
    <title>Tampil Data - Pabrik</title>
...
<body class="bg-gray-900 text-gray-200 font-sans p-6">
    ...
    <div class="container mx-auto">
        ...
        <!-- Main Content -->
        <h2 class="text-3xl font-semibold text-center mt-8">Data Pabrik</h2>

        <!-- Add Button -->
        <div class="text-center my-4">
            <form method="POST" action="tambahPabrik.php" class="inline">
            ...
            <table class="min-w-full bg-gray-800 text-gray-200 border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Code Pabrik</th>
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Nama Pabrik</th>
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Alamat</th>
                ...
                <tbody>
                    ...
                    include 'koneksi.php';
                    $no = 1;
                    $data = mysqli_query($koneksi, "SELECT * FROM pabrikobat    ");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <tr class="hover:bg-gray-700 hover:text-white">
                            <td class="border px-4 py-2"><?php echo $no++; ?></td>
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($d['code_pabrik']); ?></td>
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($d['NamaPabrik']); ?></td>
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($d['alamat']); ?></td>
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($d['noTelp']); ?></td>
                            <td class="border px-4 py-2">
                                <a href="ubahPabrik.php?code_pabrik=<?php echo $d['code_pabrik']; ?>" class="bg-yellow-600 hover:bg-yellow-700 text-white py-1 px-3 rounded shadow">Ubah</a>
                                <a href="hapusPabrik.php?code_pabrik=<?php echo $d['code_pabrik']; ?>" class="bg-red-600 hover:bg-red-700 text-white py-1 px-3 rounded shadow">Hapus</a>
                            </td>
                        </tr>
                    <?php 
                    }
