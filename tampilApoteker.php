...
<head>
    ...
    <title>Tampil Data - Apoteker</title>
...
<body class="bg-gray-900 text-gray-200 font-sans p-6">
    ...
    <div class="container mx-auto">
        ...
        <div class="bg-gray-800 p-4 rounded-lg flex justify-between items-center shadow-md mb-6">
            <div class="flex items-center">
                <img src="foto1.jpg" alt="Avatar" class="w-16 h-16 rounded-full border-4 border-gray-200 mr-4"> <!-- Replace with your avatar URL -->
        ...
        <!-- Main Content -->
        <h2 class="text-3xl font-semibold text-center mt-8">Data Apoteker</h2>

        <!-- Add Button -->
        <div class="text-center my-4">
            <form method="POST" action="tambahApoteker.php" class="inline">
            ...
            <table class="min-w-full bg-gray-800 text-gray-200 border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Code Apoteker</th>
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Nama</th>
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">Email</th>
                        <th class="px-4 py-2 bg-indigo-500 text-gray-100 border border-gray-700">No Telepon</th>
                ...
                <tbody>
                    ...
                    include 'koneksi.php';
                    $no = 1;
                    $data = mysqli_query($koneksi, "SELECT * FROM apoteker");
                    while ($d = mysqli_fetch_array($data)) {
                    ?>
                        <tr class="hover:bg-gray-700 hover:text-white">
                            <td class="border px-4 py-2"><?php echo $no++; ?></td>
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($d['code_apoteker']); ?></td>
                            ...
                            <td class="border px-4 py-2">
                                <a href="ubahApoteker.php?code_apoteker=<?php echo $d['code_apoteker']; ?>" class="bg-yellow-600 hover:bg-yellow-700 text-white py-1 px-3 rounded shadow">Ubah</a>
                                <a href="hapusApoteker.php?code_apoteker=<?php echo $d['code_apoteker']; ?>" class="bg-red-600 hover:bg-red-700 text-white py-1 px-3 rounded shadow">Hapus</a>
                            </td>
                        </tr>
                    <?php 
                    }
    ...
    <script>
        // Toggle navbar visibility on hamburger icon click
